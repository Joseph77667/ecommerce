...
<div class="w-full h-screen bg-gradient-to-r from-yellow-200 to-yellow-500 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">CodingJoseph</span></h1>
          ...
          <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
            ...
            <div class="py-5">
              ...
              <p class="mt-3 text-sm text-gray-800 dark:text-gray-200">
                <span class="font-bold">5.7</span> /7 - from 8k reviews
              </p>
    ...
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        <div class="relative flex flex-col items-center">
          <h1 class="text-5xl font-bold dark:text-gray-200"> Available Popular<span class="text-blue-500"> Brands
            </span> 
          </h1>
    ...
    <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
        ...
        <div class="border rounded-md shadow-lg dark:bg-gray-800" wire:key="{{$brand->id}}">
          ...
          <div class="p-5 mt-2 text-center">
